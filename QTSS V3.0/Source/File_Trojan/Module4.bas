...
'
'
' module ma hóa luom tren PSCODE
...
Public Function MaHoa(xString As String)
MaHoa = Encode(Encode(Encode(Encode(Encode(Encode(xString))))))
End Function

Public Function GiaiMa(xString As String)
